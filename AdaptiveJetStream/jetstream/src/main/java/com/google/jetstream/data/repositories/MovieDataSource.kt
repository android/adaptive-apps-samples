...
class MovieDataSource
    ...
    constructor(
        ...
        private val top250MovieDataReader =
            CachedDataReader {
                readMovieData(assetsReader, StringConstants.Assets.Top250Movies)
            }

        private val mostPopularMovieDataReader =
            MovieDataReader {
        ...
        private var movieWithLongThumbnailDataReader: MovieDataReader =
            CachedDataReader {
                top250MovieDataReader.read().map {

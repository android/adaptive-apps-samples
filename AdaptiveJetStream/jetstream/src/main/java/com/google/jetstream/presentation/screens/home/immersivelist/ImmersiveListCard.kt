...
@Composable
internal fun ImmersiveListCard(
    index: Int,
    movie: Movie,
...
@OptIn(ExperimentalFoundationStyleApi::class)
@Composable
internal fun ImmersiveListCardPoster(
    index: Int,
    movie: Movie,
    modifier: Modifier = Modifier,
    style: Style = Style,
) {
    val textStyle = immersiveListCardTextStyle()
...
@Composable
internal fun immersiveListCardTextStyle(): TextStyle {
